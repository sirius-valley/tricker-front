...
export const TeamMemberManagement: React.FC<TeamMemberManagementProps> = ({
  ...
  return (
    <>
      ...
      {!error && (
        <div className="text-white flex flex-col items-center justify-center mx-8 lg:h-[370px] md:w-fit lg:w-[1032px] bg-gray-600 shadow-2 md:shadow-none border border-primary-400 py-10 px-6 md:py-20 md:px-[140px] gap-8 md:gap-10 rounded-xl">
