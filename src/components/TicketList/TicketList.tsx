...
const TicketList: React.FC<TicketListProps> = ({
  ...
  return (
    <>
      ...
      {variant === 'list' ? (
        <div
          className={`w-full max-w-[467px] h-full bg-gray-500 ${data ? 'overflow-y-scroll' : 'overflow-y-hidden'} scrollbar-hide md:rounded-bl-xl`}
        >
          {isLoading && (
            <div className="p-1">
        ...
        <div
          className={`w-full max-w-full md:max-w-[467px] h-[770px] bg-gray-500 ${data ? 'overflow-y-auto' : 'overflow-y-hidden'} scrollbar-hide md:rounded-bl-xl`}
        >
          {isLoading && (
