...
const selectInputVariants = cva(
  [
    'outline-none placeholder-gray-300 bg-transparent border rounded-lg py-2 px-4 w-[306px] h-[43px] text-gray-300'
  ],
  {
    variants: {
      variant: {
  ...
  return (
    <div className="gap-2 flex flex-col" ref={selectRef}>
      ...
      <div className="relative" style={{ width: '290px' }}>
        ...
        {isOpen && (
          <div className="absolute left-0 w-full bg-transparent">
            <div className="text-white border rounded-lg shadow-lg">
              {options.map((option) => (
                <div
                  key={option.value}
